...
in prenumee varchar(25), in adress varchar(50), in nr_telefonn varchar(12), in e_maill varchar(30), in ibann varchar(30), in nr_contractt varchar(10),
normaa int, salariuu int, sucursalaa varchar(30), departamentt varchar(30))
begin 
	declare key_user INT;
	insert into utilizatori(username, parola, cnp, nume, prenume, adresa, nr_telefon, e_mail, iban, nr_contract)
    values(usernamee, parolaa, cnpp, numee, prenumee, adress, nr_telefonn, e_maill, ibann, nr_contractt);
    ...
    insert into angajat(username,parola,angajat_id, norma, salariul,sucursala_id,departament_id)
    values(usernamee, parolaa,key_user, normaa, salariuu,(select id from sucursala where nume = sucursalaa), (select id from departament where nume = departamentt));
end; //
delimiter ;
...
values(id_contt,sumaa,curdate(),perioadaa);
update cont
...
begin
declare k int;
call find_iban('ROING87654821',k);
select k;
end; //
delimiter ;
...
call create_account_angajat('alexandrei', 'doruclean', '5010745567123', 'Alexa', 'Andrei', 'Bucegi 30', '0745015823', 'alexandrei@yahoo.com', 'ROBT413745039', '123402', 8, 2000, 'Cluj-Napoca', 'IT');
call create_account_angajat('mircea123', 'celbatran', '5021452148965', 'Mircea', 'Mare', 'Mures 35', '0768642571', 'mirceamare@yahoo.com', 'ROBT65701453', '145621', 8, 2000, 'Targu Mures', 'Functionar');
call create_account_angajat('paul4321', 'paul1234', '50423654785', 'Paul', 'Petrescu', 'Arges,nr 14', '0735631745', 'paulpetrescu@yahoo.com', 'ROBT56241235', '23', 4, 3500, 'Brasov', 'HR');
...
call create_cont_client(100, 'FACTURI', 'ROBT099877655', 'gavreaioan', 'gavrea100');
